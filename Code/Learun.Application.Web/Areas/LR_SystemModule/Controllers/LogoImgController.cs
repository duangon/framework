            ...
            try
            {
                switch (code)
                {
                    ...
                    case "applogo":
                        ...
                        break;
                    case "anshanmining":
                        files[0].SaveAs(rootPath + "/Content/images/logo/anshanmining.png");
                        break;
                }
            }
            catch (Exception e)
        ...
        public ActionResult GetImg(string code)
        {
            ...
            try
            {
                switch (code)
                {
                    ...
                    case "anshanmining":
                        var byteanshanmining = System.IO.File.ReadAllBytes(Path.Combine(rootPath, midPath, "anshanmining.png"));
                        return File(byteanshanmining, "image/jpeg");
                }
            }
            catch (Exception e)
            {
